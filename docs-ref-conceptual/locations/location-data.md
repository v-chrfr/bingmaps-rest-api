...
|point|Point|Point. For more information about the Point type, see [Location and Area Types](../services/location-and-area-types.md).|The latitude and longitude coordinates of the location.|  
